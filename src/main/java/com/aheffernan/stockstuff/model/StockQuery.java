...
public class StockQuery extends StockData{
    ...
    public StockQuery(@NotNull String symbol, @NotNull String from, @NotNull String until) throws ParseException {
        super();
        this.symbol = symbol;
        this.from = LocalDateTime.parse(from, DateTimeFormat.forPattern(StockQuote.dateFormat));
        this.until = LocalDateTime.parse(until, DateTimeFormat.forPattern(StockQuote.dateFormat));
    }
